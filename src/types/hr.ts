...
export type ViewType = 'dashboard' | 'employees' | 'contracts' | 'attendance' | 'employee-attendance' | 'leave' | 'payroll' | 'eos' | 'calendar' | 'performance' | 'discipline' | 'orgchart' | 'company-docs' | 'settings';
