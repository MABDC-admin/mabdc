...
export type ViewType = 'dashboard' | 'visa-process' | 'employees' | 'deactivated' | 'time-shift' | 'time-clock' | 'e-portal' | 'contracts' | 'renewal' | 'smart-upload' | 'attendance' | 'employee-attendance' | 'attendance-appeals' | 'leave' | 'payroll' | 'eos' | 'calendar' | 'performance' | 'discipline' | 'orgchart' | 'company-docs' | 'reports' | 'settings' | 'monthly-matrix';
