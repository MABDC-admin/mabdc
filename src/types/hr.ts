...
export type ViewType = 'dashboard' | 'gamification' | 'employees' | 'time-shift' | 'e-portal' | 'contracts' | 'attendance' | 'employee-attendance' | 'attendance-appeals' | 'leave' | 'payroll' | 'eos' | 'calendar' | 'performance' | 'discipline' | 'orgchart' | 'company-docs' | 'settings';
